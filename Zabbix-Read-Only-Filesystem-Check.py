...
This will be used in conjuction with the Zabbix monitoring and alerting system.
the script will return the name of the FS in read-only mode
'''
...
def get_fs():
    ...
    ssh = subprocess.Popen(("ssh -i {} {}@{} {}".format(key, user, hostname, cmd)), shell=True, stderr=subprocess.PIPE, stdout=subprocess.PIPE)
    ...
    for line in lines:
        ...
        if 'ro' in opts.split(','):
            ...
            send_to_zabbix(zbx_key_name, name)
